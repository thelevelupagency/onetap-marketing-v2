...
export function MarketingCarouselCard(props: MarketingCarouselCardProps) {
  if (props.variant === "image") {
    ...
    const isAppOutbound = href.startsWith("http");
    if (isAppOutbound) {
      return (
        <AppOutboundLink href={href} placement="solutions_carousel" className={cn(cardShellLight, "group w-full")}>
          <CarouselImageBody
            image={image}
            imageAlt={imageAlt}
            title={title}
