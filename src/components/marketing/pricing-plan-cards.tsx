      ...
      {plans.map((plan) => {
        ...
        return (
          ...
          >
            ...
            <h3 className={cn("font-display text-2xl mb-2", isPopular && "text-brand-turquoise")}>
              {plan.name}
            </h3>
              ...
              <Button
                className={cn(
                  ...
                  isPopular
                    ...
                    : "bg-brand-navy text-brand-cream hover:bg-brand-turquoise hover:text-brand-midnight",
                )}
              >
                {plan.cta}
              </Button>
