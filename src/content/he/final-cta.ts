...
export const finalCtaVariants: Record<FinalCtaVariant, FinalCtaCopy> = {
  ...
  pricing: {
    ...
    accent: "להתחיל?",
    subheadline:
      "השיקו את הכרטיס שלכם בתוכנית חינם תוך דקות - או בחרו Pro או Team כשאתם צריכים יותר עוצמה, מיתוג ושליטה בסביבת עבודה משותפת.",
    cta: "צרו את הכרטיס שלכם בחינם",
    microcopyItems: ["תוכנית חינם זמינה", "בלי אפליקציה", "שדרגו בכל עת"],
  },
  blog: {
    title: "מוכנים ליישם",
    accent: "את מה שקראתם?",
